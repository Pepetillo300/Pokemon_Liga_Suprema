...
EventHandlers.add(:following_pkmn_item, :regular, proc { |_pkmn, _random_val|
  items = [
	...
	:GREATBALL,	    :ULTRABALL,		:THUNDERSTONE, 	:MOONSTONE,     :SUNSTONE,      
	:DUSKSTONE,		:REDAPRICORN,  	:BLUEAPRICORN, 	:YELLOWAPRICORN,:GREENAPRICORN,
	:PINKAPRICORN,	:BLACKAPRICORN, :WHITEAPRICORN
  ]
